...
{
    _element_name = "AUTO " + string(__guido_auto_element) + ", real field, variable=\"" + string(_variable) + "\"";
...
if (_element_array[__GUIDO_ELEMENT.NEW])
{
    ...
    _element_array[@ __GUIDO_ELEMENT.FIELD_STRING] = guido_string_format(_value);
