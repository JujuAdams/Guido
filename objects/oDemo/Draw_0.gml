...
switch(tab)
{
    case 0:
        ...
        guido_newline();
        guido_newline();
        guido_text_ext("This library is designed with debug tools in mind. Its various UI elements (also called \"widgets\") should cover the vast majority of backend tool use cases.", -1, 1000);
    break;
    ...
    case 2:
        ...
        guido_text("There are other GUI elements on offer too:");
        guido_newline();
        guido_newline();
